...
var _ = check.Suite(&CronjobSuite{})

func (s *CronjobSuite) createUserAndTeam(c *check.C) {
...
func (s *CronjobSuite) reset() {
	s.provisioner.Reset()
	routertest.FakeRouter.Reset()
	repositorytest.Reset()
}

func (s *CronjobSuite) SetUpSuite(c *check.C) {
...
func (s *CronjobSuite) TearDownSuite(c *check.C) {
...
func (s *CronjobSuite) SetUpTest(c *check.C) {
...
func (s *CronjobSuite) TestBuildHandler(c *check.C) {
...
func (s *CronjobSuite) TestBuildArchiveURL(c *check.C) {
	s.builder.OnBuild = func(p provision.BuilderDeploy, app provision.App, evt *event.Event, opts *builder.BuildOpts) (string, error) {
...
func (s *CronjobSuite) TestBuildWithoutTag(c *check.C) {
